...
<%@ taglib prefix="c" uri="http://java.sun.com/jstl/core_rt"%>
	<div id='cssmenu'>
		<ul>
			...
			<c:if test="${sessionScope.group=='AdminGroup'}">
				...
				<li class="has-sub"><a href='domains?domainType=skill'><span>Colleague/Skill
					...
					<ul>
						...
						<li><a href="domains?domainType=practice">Practice
								Domains</a></li>
			...
			<li class="has-sub"><a
				href='/qualityassessor/assessmentRequests'><span>Reviews</span></a>
		...
		<div style="padding: 3px 10px;position:absolute;right:220px;"><img style="width:12px;height:12px" class="newDomain" src="images/plus.png">
