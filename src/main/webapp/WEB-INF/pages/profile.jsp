...
<body>
	<div class="background container">
		...
		<h2 style="margin: 30px 30px 10px 120px;">User Profile</h2>
			<table class="zebra-striped"
				style="width: 650px; margin: 30px 30px 10px 120px; border: 1px solid #CCCCCC;">
				<thead>
					<tr style="background-color: #F9F9F9;">
						<td  style="text-align: center;border-bottom: 1px solid #CCCCCC;" colspan="4"><strong class="headerStrong"  >Personal Details</strong></td>
					</tr>
				</thead>
				...
				<tr style="background-color: white;">
					...
					<td class="span3"><input id="firstName" name="firstName" type="text"></td>
					<td class="span3"><input id="middleName" name="middleName" type="text"></td>
					<td class="span3"><input id="lastName" name="lastName" type="text"></td>
				</tr>
				<tr style="background-color: white;">
					<td class="span3"><strong>Email</strong></td>
					<td  class="span3"><input 
						name="emailAddress" type="text"></td>
				</tr>
			</table>
			...
			<table class="zebra-striped"
				...
				<thead>
					<tr style="background-color: #F9F9F9;">
						<td style="text-align: center;border-bottom: 1px solid #CCCCCC;" colspan="4"><strong class="headerStrong"  >Address Details</strong></td>
					</tr>
				</thead>
			...
			<table id="workExpTable1" class="zebra-striped"
				...
				<thead>
					<tr style="background-color: #F9F9F9;">
						<td style="text-align: center;border-bottom: 1px solid #CCCCCC;" colspan="5"><strong class="headerStrong"  >Work Experience</strong></td>
					</tr>
				</thead>
			...
			<table id="socialNetwork1" class="zebra-striped"
				...
				<thead>
					<tr style="background-color: #F9F9F9;"
						...
						<td style="text-align: center;border-bottom: 1px solid #CCCCCC;" colspan="5"><strong class="headerStrong"  >Social Network</strong></td>
					</tr>
				</thead>
